...
const generateTeam = (team) => {
  console.log("TEAM MEMBERS ARRAY FROM INDEXjs", team);
  ...
  const generateEngineer = (engineer) => {
    ...
    <div class="card-body">
        <ul class="list-group">
            ...
            <li class="list-group-item">Github: <a href= "https://github.com/${engineer.getGithub()}" target="_blank" rel="noopen noreferrer">${engineer.getGithub()}</a></li>
        </ul>
    </div>
</div>
        `;
